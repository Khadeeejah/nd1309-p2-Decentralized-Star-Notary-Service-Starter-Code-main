...
contract StarNotary is ERC721 {
    ...
    string private _gold; // Name of the token
    string private _gd; // Symbol of the token

    // Constructor to set the name and symbol
    constructor() ERC721("GOLD", "GNFT") {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            msg.sender == ownerOfToken1 || msg.sender == ownerOfToken2,
            "You must be the owner of one of the tokens to exchange them."
        );
